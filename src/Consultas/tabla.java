...
//        System.out.println("Se metió al método");
        ...
        String[] titulos = {"ID","Clave", "Nombre","Nombre completo", "Apellidos", "Fecha de nacimiento", "localidad","Dirección", "calle", 
                "N. interior", "No. exterior", "telefono", "celular", "nombre del tutor"};
