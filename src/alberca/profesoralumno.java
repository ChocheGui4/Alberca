...
//                        System.out.println("Me imprimo cada segundo");
    ...
    public void mostrar() {
        try {
            ...
            modelo = tab.usuariosporamestroaldia("" + m, "" + d, h);
//            ocultar_columnas();
...
//            lblregistros.setText("Registros: " + Integer.toString(tab.totalregistros));
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(40, 140, 1180, 420);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(profesoralumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new profesoralumno().setVisible(true);
            }
        });
    }
